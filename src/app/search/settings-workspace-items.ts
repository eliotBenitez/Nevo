...
export function buildWorkspaceSearchItems(
  ...
  return [
    ...
    item('graphEntryMode', t('settings.workspace.graphEntryMode.title'), t('settings.workspace.graphEntryMode.description'), t(`settings.options.graphEntryMode.${ws.graphEntryMode}`)),
  ]
}
