## [2026-06-19]
- Добавлено краткое описание проекта для GitHub-репозитория и файла README.
- Исправлено отображение логотипа и скриншотов в файле readme/README_EN.md на GitHub (откорректированы относительные пути).
